...
NProgress.configure({ showSpinner: false }) // NProgress Configuration 小圆环

const whiteList = ['/login', '/auth-redirect'] //白名单 no redirect whitelist

//beforeeach是路由的全局首位，所有路由都经过这个方法
